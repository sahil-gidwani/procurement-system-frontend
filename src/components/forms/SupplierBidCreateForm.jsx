...
export default function SupplierBidCreateForm() {
  ...
  const onSubmit = async (data) => {
    ...
    api
      .post(
        `${baseURL}/purchase/supplier-bids/create/${requisition_id}/`,
        formData,
        {
          headers: {
      ...
      <div className="container mx-auto">
        <div className="mx-auto my-12 flex w-full flex-wrap justify-center rounded-lg p-6 pb-10 pt-5 shadow-2xl lg:w-7/12">
          <FormHeader
            icon={BiPurchaseTag}
            title="Submit Bid"
            subTitle="Fill in the form below to submit a bid for the purchase requisition"
