...
export default function InventoryReceiptCreateForm() {
  ...
  const onSubmit = async (data) => {
    ...
    api
      ...
      .then((response) => {
        ...
        Toast.fire({
          icon: "success",
          title: "Inventory receipt created successfully!",
        });
      ...
      .catch((error) => {
        ...
        Toast.fire({
          icon: "error",
          title: "Error creating inventory receipt!",
        });
      ...
      <div className="container mx-auto">
        <div className="mx-auto my-12 flex w-full flex-wrap justify-center rounded-lg p-6 pb-10 pt-5 shadow-2xl lg:w-7/12">
          <FormHeader
            ...
            subTitle="Fill in the details below to create a new inventory receipt"
          />
          <form
